...
from pyspark.sql.functions import Column, col, upper, length
...
# dataFile.select(col("payload.issue.state")).show()
# dataFile.select(col("payload.issue.state")).distinct().show()
# dataFile.select(col("payload.issue.state")).distinct().selectExpr('count(state)').show()
#
# dataFile.select(col("payload.issue.state")).distinct().selectExpr('count(*)').show()
